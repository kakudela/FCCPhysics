...
inputDir = "output/h_za/treemaker/ecm240/qqqqa"


tag = "bdt_model_qqqqa_ecm240"
variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet3_theta", "jet4_theta", "jet1_p", "jet2_p", "jet3_p", "jet4_p", "photon_p", "photon_theta"]
sig_procs = ['wzp6_ee_ccH_HZa_ecm240', 'wzp6_ee_bbH_HZa_ecm240', 'wzp6_ee_qqH_HZa_ecm240', 'wzp6_ee_ssH_HZa_ecm240']
bkg_procs = ['p8_ee_ZZ_ecm240', 'wz3p6_ee_uu_ecm240', 'wz3p6_ee_dd_ecm240', 'wz3p6_ee_cc_ecm240', 'wz3p6_ee_ss_ecm240', 'wz3p6_ee_bb_ecm240']
...
ROOT.TMVA.Experimental.SaveXGBoost(bdt, f"bdt_model_{cat}", fOutName, num_inputs=len(variables))
