...
'''
if cat == "hqqa":
    tag = "bdt_model_hqqa_ecm240"
    variables = ["qqa_m", "qq_m", "vv_recoil_m", "qq_recoil_m", "vva_m", "qqa_p", "qq_p", "qqa_recoil_m", "vv_m", "vva_p", "dr_vv_qqa", "dr_qq_vva", "dr_a_qq" ,"dr_a_vv", "mass_difference_qqa_vv", "mass_difference_vva_qq", "cos_qqa", "cos_qq", "cos_vva", "photon_p", "photon_theta"]
    variables = ["qqa_m", "qq_m", "vv_recoil_m", "qqa_p", "qq_p", "qqa_recoil_m", "vv_m", "vva_p", "dr_vv_qqa", "dr_qq_vva", "dr_a_qq" ,"dr_a_vv", "mass_difference_qqa_vv", "mass_difference_vva_qq", "photon_p", "photon_theta"]

    sig_procs = ['wzp6_ee_nunuH_HZa_ecm240']
    bkg_procs = ['p8_ee_ZZ_ecm240']

if cat == "hvva":
    tag = "bdt_model_hvva_ecm240"
    variables = ["qqa_m", "qq_m", "vv_recoil_m", "qq_recoil_m", "vva_m", "qqa_p", "qq_p", "qqa_recoil_m", "vv_m", "vva_p", "dr_vv_qqa", "dr_qq_vva", "dr_a_qq" ,"dr_a_vv", "mass_difference_qqa_vv", "mass_difference_vva_qq", "cos_qqa", "cos_qq", "cos_vva", "photon_p", "photon_theta"]
    variables = ["qq_m", "qq_recoil_m", "vva_m", "qqa_p", "qq_p", "qqa_recoil_m", "vv_m", "vva_p", "dr_vv_qqa", "dr_qq_vva", "dr_a_qq" ,"dr_a_vv", "mass_difference_qqa_vv", "mass_difference_vva_qq", "photon_p", "photon_theta"]
...
if cat == "qqqq":
    inputDir = "/ceph/submit/data/group/fcc/ee/analyses/h_za/treemaker/ecm240/qqqq/"
    tag = "bdt_model_qqqq_ecm240"
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet3_theta", "jet4_theta", "jet1_p", "jet2_p", "jet3_p", "jet4_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference"]
    sig_procs = ['wzp6_ee_ccH_HZa_ecm240', 'wzp6_ee_bbH_HZa_ecm240', 'wzp6_ee_qqH_HZa_ecm240', 'wzp6_ee_ssH_HZa_ecm240']
    bkg_procs = ['wz3p6_ee_uu_ecm240', 'wz3p6_ee_dd_ecm240', 'wz3p6_ee_cc_ecm240', 'wz3p6_ee_ss_ecm240', 'wz3p6_ee_bb_ecm240']
    # 'p8_ee_ZZ_ecm240', 
    bkg_procs = ['p8_ee_ZZ_ecm240']
'''

if tag == "qqvv_qqa_splitting_mva":
    inputDir = "/ceph/submit/data/group/fcc/ee/analyses/h_za/treemaker/ecm240/qqvv_qqa_splitting_mva/"
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet1_p", "jet2_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference_H_Z", "dr_H_Z", "dr_a_H", "dr_a_Z", "cos_H", "cos_Z", "vv_trans", "qq_trans", "vv_long", "qq_long"]
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet1_p", "jet2_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference_H_Z", "dr_H_Z", "dr_a_H", "dr_a_Z", "vv_trans", "qq_trans"]
    sig_procs = ['wzp6_ee_nunuH_HZa_ecm240', 'wzp6_ee_ccH_HZa_ecm240', 'wzp6_ee_bbH_HZa_ecm240', 'wzp6_ee_qqH_HZa_ecm240', 'wzp6_ee_ssH_HZa_ecm240']
    bkg_procs = ['p8_ee_ZZ_ecm240']
...
if tag == "qqvv_pairing_chi2":
    inputDir = "/ceph/submit/data/group/fcc/ee/analyses/h_za/treemaker/ecm240/qqvv_pairing_chi2/"
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet1_p", "jet2_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference_H_Z", "dr_H_Z", "dr_a_H", "dr_a_Z", "cos_H", "cos_Z", "vv_trans", "qq_trans", "vv_long", "qq_long"]
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet1_p", "jet2_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference_H_Z", "dr_H_Z", "dr_a_H", "dr_a_Z", "vv_trans", "qq_trans"]
    sig_procs = ['wzp6_ee_nunuH_HZa_ecm240', 'wzp6_ee_ccH_HZa_ecm240', 'wzp6_ee_bbH_HZa_ecm240', 'wzp6_ee_qqH_HZa_ecm240', 'wzp6_ee_ssH_HZa_ecm240']
    bkg_procs = ['p8_ee_ZZ_ecm240']
...
if tag == "bdt_model_qqvv_pairing_chi2_ecm240":
    inputDir = "/ceph/submit/data/group/fcc/ee/analyses/h_za/treemaker/ecm240/qqvv_pairing_chi2/"
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet1_p", "jet2_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference_H_Z", "dr_H_Z", "dr_a_H", "dr_a_Z", "cos_H", "cos_Z", "vv_trans", "qq_trans", "vv_long", "qq_long"]
    variables = ["H_m", "H_p", "Z_m", "Z_p", "ZH_m", "ZH_p", "jet1_theta", "jet2_theta", "jet1_p", "jet2_p", "photon_p", "photon_theta", "H_recoil_m", "H_recoil_p", "Z_recoil_m", "Z_recoil_p", "mass_difference_H_Z", "dr_H_Z", "dr_a_H", "dr_a_Z", "vv_trans", "qq_trans"]
    sig_procs = ['wzp6_ee_nunuH_HZa_ecm240', 'wzp6_ee_ccH_HZa_ecm240', 'wzp6_ee_bbH_HZa_ecm240', 'wzp6_ee_qqH_HZa_ecm240', 'wzp6_ee_ssH_HZa_ecm240']
