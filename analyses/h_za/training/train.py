...
variables = ["qqa_m", "qq_m", "vv_recoil_m", "qq_recoil_m", "vva_m", "qqa_p", "qq_p"]


sig_procs = ['wzp6_ee_nunuH_HZa_ecm240']

bkg_procs = ['wzp6_ee_ccH_HZa_ecm240', 'wzp6_ee_bbH_HZa_ecm240', 'wzp6_ee_qqH_HZa_ecm240', 'wzp6_ee_ssH_HZa_ecm240']

inputDir = "output/h_za/treemaker/ecm240/test"
